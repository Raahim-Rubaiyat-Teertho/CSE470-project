...
export default function ArtistStats() {
    ...
    async function fetchStats() {
        try {
            const response = await fetch(`http://localhost:8000/stats/artist/getUpvoteNumbers/${uname}`);
    ...
    async function fetchEarnings() {
      const res1 = await fetch(`http://localhost:8000/stats/artist/${uname}`);
    ...
    return (
        <div>
            ...
            <div className="flex justify-center">
              <Button className='mt-10' onClick={fetchEarnings}>Check Your Earnings</Button>
            </div>
            ...
            <div>
              {
                posts2 && (
                  <div className="mt-10 text-center mb-10">
                    ...
                    <p>Total Earnings: {posts2.totalEarnings} taka</p>
