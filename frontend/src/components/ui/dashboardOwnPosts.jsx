...
export default function DashboardOwnPosts () {
    ...
    return (
        ...
        <div className="flex justify-center mt-10">
          <button className="px-4 py-2 mr-3 border-2 rounded-md" onClick={handleSetShowOwnPosts}>Your posts</button>
          <button className="px-4 py-2 border-2 rounded-md" onClick={handleSetShowOwnMusic}>Your music</button>
        </div>
