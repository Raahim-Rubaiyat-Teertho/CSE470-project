...
async function getAllAudienceStats(req, res) {
    try {
        ...
        console.error("Error occurred while retrieving audience stats:", error);
        res.status(500).json({ error: "Internal server error" });
    }
}

async function getAllAudienceStatsByUname(req, res) {
    try {
        ...
        console.error("Error occurred while retrieving audience stats by uname:", error);
        res.status(500).json({ error: "Internal server error" });
    }
}
